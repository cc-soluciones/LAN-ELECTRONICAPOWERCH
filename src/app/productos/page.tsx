                ...
                <div className={index % 2 === 1 ? "md:order-2" : ""}>
                  <div className="bg-gradient-to-br from-primary/20 to-secondary/20 rounded-lg aspect-video flex items-center justify-center">
                    <div className="text-center p-8">
                      <div className="text-6xl font-bold text-primary/40 mb-2">{category.name.split(" ")[0]}</div>
                      <div className="text-muted-foreground">Imagen del producto</div>
                    </div>
                  </div>
                </div>
                <div>
                  ...
                  <div className="border-t border-border pt-4">
                    <div className="text-sm text-muted-foreground mb-2">Marcas disponibles:</div>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">Soporte Técnico Incluido</h2>
            <p className="text-muted-foreground mb-8">
              Todos nuestros productos incluyen instalación profesional, garantía extendida y servicio de mantenimiento
              preventivo
            </p>
